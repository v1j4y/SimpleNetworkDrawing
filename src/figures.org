...
from block_sparse_matrix import draw_simple_matrix
...
draw_simple_matrix(
    d, coo, size=0.6, leg_length=0.4, pointing="in",
    color=schematic.get_color("orange"), leg_color=d.drawcolor,
)
...
** Symmetry
#+begin_src python :file figs/paper1.3.0.png
import sys
sys.path.insert(0, "src")
from block_sparse_matrix import draw_symmetry_equivalence

draw_symmetry_equivalence(fname="/home/chilkuri/Documents/claude/SimpleNetworkDrawing/figs/paper1.3.0.png")
...
d.text((2,-0.6), "$\Lambda$", fontsize=20)
draw_simple_matrix(
    d, coo, size=0.6, leg_length_left=0.7, leg_length_right=0.7, pointing="in",
    color=schematic.get_color("orange"), leg_color=d.drawcolor,
)
...
d.text((2,5+0.5), "$\Lambda^{\dagger}$", fontsize=20)
draw_simple_matrix(
    d, coo, size=0.6, leg_length_left=0.7, leg_length_right=0.7, pointing="out",
    color=schematic.get_color("orange"), leg_color=d.drawcolor,
)
...
draw_simple_matrix(
    d, coo, size=0.6, leg_length_left=0.4, leg_length_right=0.7, pointing="in",
    color=schematic.get_color("orange"), leg_color=d.drawcolor,
)
...
draw_simple_matrix(
    d, coo, size=0.6, leg_length_left=0.4, leg_length_right=0.7, pointing="out",
    color=schematic.get_color("orange"), leg_color=d.drawcolor,
)
d.line((2-0.0,2-0.0), (2-1.0+0,2-0.0), arrowhead=dict(center = 0.5, reverse=False) )
d.fig.savefig("/home/chilkuri/Documents/claude/SimpleNetworkDrawing/figs/paper1.5.png")
d.fig.savefig("/home/chilkuri/Documents/claude/SimpleNetworkDrawing/figs/paper1.5.pdf")
#+end_src
